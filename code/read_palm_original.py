...
if __name__ == '__main__':
    ...
    # TODO: Add parser input
    # args = parser.parse_args()
    change_to_project_path(__file__)

    # image_path = "/home/selfapp/Work_Sun/SunGit/Crack-Segmentation/output/dataset/palm-thick3-multiline/input/IMG_FEMALE_0016.jpg"
    image_path = "../data/Palm/thick3-category/multiline/input/IMG_FEMALE_0083.jpg"
